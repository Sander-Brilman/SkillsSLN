    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssingmentsAnswers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AssingmentsAnswers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AssingmentsAnswers_Assingments_AssingmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssingmentsAnswers_AssingmentId",
                table: "AssingmentsAnswers",
                column: "AssingmentId");

            migrationBuilder.CreateIndex(
                name: "IX_AssingmentsAnswers_UserId",
                table: "AssingmentsAnswers",
                column: "UserId");
        }
